...
void main(void)
	...
	SerialPortSettings.c_lflag &= ~(ECHO | ECHOE | ISIG);  //  Disable echo and signal handling  
	SerialPortSettings.c_lflag |= ICANON ;  //  Enable Cannonical mode  
	SerialPortSettings.c_oflag &= ~OPOST;	// No Output Processing

	//Disable Setting Time outs 
